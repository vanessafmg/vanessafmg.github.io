...
<body>
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3>Consultar Carros</h3>
                <div>
                    <input type="button" onclick="window.location='form_cadastro_carros.php'" value="Cadastrar" class="btn btn-info">
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title custom_align" id="Heading">Excluir Carro</h4>
                </div>
                ...
                <div class="modal-footer ">
                    ...
                    <button onclick="window.location='excluir_carros.php?id='+document.getElementById('id_exclusao').value" type="button" class="btn btn-success">
